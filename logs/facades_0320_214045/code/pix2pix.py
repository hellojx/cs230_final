...
class Pix2Pix():
    def __init__(self, batch_size=1):
        ...
        self.data_loader = DataLoader(dataset_name=self.dataset_name,
                                      img_res=(self.img_rows, self.img_cols), batch_size=batch_size)
    ...
    def train(self, epochs, batch_size=1, save_interval=50):
        ...
        for epoch in range(epochs):
            ...
            if epoch % save_interval == 0:
                ...
                self.combined.save('saved_model/combined_model_' + str(epoch) + '.h5')
...
if __name__ == '__main__':
    gan = Pix2Pix(batch_size=4)
    gan.train(epochs=30000, batch_size=4, save_interval=25)
